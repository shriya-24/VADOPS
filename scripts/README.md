...
## eval_clinc.sh 
  ...
  - Need 3 command args:
    ...
    ```sbatch eval_clinc.sh small ../checkpoints/clinc_small/checkpoint-10468/ ../predictions/clinc_small.csv```
...
## eval_snips.sh 
  ...
  - Need 2 command args:
    ...
    ```sbatch eval_snips.sh ../checkpoints/snips/checkpoint-10468/ ../predictions/snips.csv```
