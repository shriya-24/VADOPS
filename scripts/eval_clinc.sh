...
python ../models/CLINC.py eval $1 $2 $3

# Examples
# Using python: python ../models/CLINC.py eval {clinc_subset} /path/to/checkpoint /path/to/prediction/{fileName}.csv
# Using python: python ../models/CLINC.py eval small ../checkpoints/clinc_small/checkpoint-10468/ ../predictions/clinc_small.csv

# Using bash: sbatch eval_clinc.sh {clinc_subset} /path/to/checkpoint /path/to/prediction/{fileName}.csv
# Using bash: sbatch eval_clinc.sh small ../checkpoints/clinc_small/checkpoint-10468/ ../predictions/clinc_small.csv
