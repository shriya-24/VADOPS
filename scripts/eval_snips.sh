...
python ../models/SNIPS.py eval $1 $2 $3

# Examples
# Using python: python ../models/SNIPS.py eval {dataset_type} /path/to/checkpoint /path/to/prediction/{fileName}.csv
# Using python: python ../models/SNIPS.py eval test ../checkpoints/snips/checkpoint-26170/ ../predictions/snips_test.csv

# Using bash: sbatch eval_snips.sh {dataset_type} /path/to/checkpoint /path/to/prediction/{fileName}.csv
# Using bash: sbatch eval_snips.sh test ../checkpoints/snips/checkpoint-26170/ ../predictions/snips_test.csv
