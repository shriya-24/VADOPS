...
# Argument 1(log_dynamics_dir): specify the dynamics folder path
# Argument 2(plot_dir): specify the plot_dir path to save the graph
# Argument 3(title):  specify title for the graph
python ../models/main.py plot $1 $2 $3

# Example
# Using python: python ../models/main.py plot /path/to/log_dynamics_dir /path/to/plot_dir {dataset_name}
# Using python: python ../models/main.py plot ../training_dynamics/clinc_small /datamap_graphs clinc_small_train

# Using bash: sbatch plot_dataMap.sh /path/to/log_dynamics_dir /path/to/plot_dir {dataset_name}
