...
# Argument 2(prompt_type): specify the prompt type. It is an integer from 1 to 5 (both inclusive)
...
# Argument 6(num_gen examples): Specify the number of examples to be generated for each class.
